export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/jasonhuang3030",
    ...
    <footer className="bg-background border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold text-accent mb-4">Jahzz</h3>
            <p className="text-muted text-sm">Building exceptional digital experiences with modern web technologies.</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted">
          <p>&copy; {currentYear} Jahzz. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
